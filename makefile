...
import/websites/gr.maharashtra.gov.in/TechEdu:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/TechEdu .
...
import: check_env import/websites/gr.maharashtra.gov.in/TechEdu .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/TechEdu import/documents
